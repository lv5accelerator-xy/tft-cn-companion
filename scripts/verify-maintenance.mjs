...
const checks = [
  ...
  ["app/components/TrainingFocusStrip.tsx", ["TRAINING_FOCUS_KEY", "WORKSPACE_EVENT", "buildTrainingProgress"]],
  ["app/components/DesktopShell.tsx", ["SessionResetButton", "EndGameReviewButton", "ReviewCaptureBridge", "TrainingFocusStrip", "V1.6.9"]],
  ["app/review/history/page.tsx", ["Undo", "exportCsv", "WindowSize", "markWorkspaceChanged"]],
  ["app/insights/page.tsx", ["10", "20", "50", "Issue changes", "TrainingFocusPanel"]],
  ["app/opengraph-image.tsx", ["ImageResponse", "1200", "630", "V1.6.9"]],
  ...
  ["public/sw.js", ["v1.6.9-practice-loop", "trimCache", "/review/history"]],
...
if (pkg.version !== "1.6.9") { console.error(`Maintenance verification failed: expected package version 1.6.9, got ${pkg.version}`); failed = true; }
...
console.log("V1.6.1–V1.6.9 maintenance contract verified: QA guardrails, visible topbar overlays, one-click session reset, explicit Focus → Review capture, review management, five-game practice loop, bounded offline caches and Neon Command UI are present.");
