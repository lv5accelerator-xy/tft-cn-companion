...
const checks = [
  ...
  ["app/components/DesktopShell.tsx", ["SessionResetButton", "EndGameReviewButton", "ReviewCaptureBridge", "V1.6.7"]],
  ["app/review/history/page.tsx", ["Undo", "exportCsv", "WindowSize", "markWorkspaceChanged"]],
  ["app/insights/page.tsx", ["10", "20", "50", "Issue changes"]],
  ["app/opengraph-image.tsx", ["ImageResponse", "1200", "630", "V1.6.7"]],
  ...
  ["public/sw.js", ["v1.6.7-set18", "trimCache", "/review/history"]],
...
if (pkg.version !== "1.6.7") { console.error(`Maintenance verification failed: expected package version 1.6.7, got ${pkg.version}`); failed = true; }
...
console.log("V1.6.1–V1.6.7 maintenance contract verified: QA guardrails, visible topbar overlays, one-click session reset, explicit Focus → Review capture, review management, trial, share metadata, bounded offline caches and Neon Command UI are present.");
