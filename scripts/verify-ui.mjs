...
const checks = [
  ["app/components/DesktopShell.tsx", ["DensityControl", "ReviewPulse", "data-ui-route", "data-command-ui", "V1.6.8"]],
...
console.log("UI contract verified: V1.6.8 Neon Command shell, tactical route styling, density, responsive breakpoints, overflow safety and reduced-motion support are present.");
